...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Boring',
            fields=[
                ('boring_id', models.AutoField(serialize=False, primary_key=True)),
        ...
        migrations.CreateModel(
            name='Filtergegevens',
            fields=[
                ('filter_id', models.AutoField(serialize=False, primary_key=True)),
        ...
        migrations.CreateModel(
            name='Peilbuis',
            fields=[
                ('peilbuis_id', models.AutoField(serialize=False, primary_key=True)),
        ...
        migrations.CreateModel(
            name='Peilbuisput',
            fields=[
                ('borehole_id', models.AutoField(serialize=False, primary_key=True)),
        ...
        migrations.CreateModel(
            name='Sondering',
            fields=[
                ('sondering_id', models.AutoField(serialize=False, primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x', models.DecimalField(null=True, max_digits=9, decimal_places=3)),
                ('y', models.DecimalField(null=True, max_digits=9, decimal_places=3)),
                ('z', models.DecimalField(max_digits=9, decimal_places=6)),
                ('status', models.CharField(default=b'nee', max_length=32)),
                ('DateCreated', models.DateTimeField(default=datetime.datetime(2015, 11, 13, 0, 7, 8, 807000))),
                ('DateMutated', models.DateTimeField(auto_now=True, null=True)),
                ('username', models.CharField(max_length=50, null=True)),
                ('geometry', django.contrib.gis.db.models.fields.PointField(srid=4326)),
            ],
